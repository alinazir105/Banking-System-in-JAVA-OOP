...
class Bank implements Serializable {
    ...
    public void CreateAccount() {
        ...
        do {
            ...
            age = scanner.nextInt();
            if (age > 0 && age < 18) {
                System.out.println("You should be atleast 18 to create an account");
                break;
            }
            if (age <= 0) {
                System.out.println("You cannot enter age 0 or negative");
            } else {
                int cnicFlag = 0;
                do {
...
class ATM {
    ...
    public void Deposit() throws IOException {
        ...
        if (loginFlag == 1) {
                ...
                if (amount < 0) {
                    System.out.println("Deposit amount cannot bo negative!");
